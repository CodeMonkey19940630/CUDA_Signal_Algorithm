#include "CUDABasebandReceiverLogarithmicAmplifierAlgorithmCore.cuh"
...
void CUDABasebandReceiverLogarithmicAmplifierAlgorithmCore(float2 * Radar_Data_Cube_Address, float2 * Receiver_Noise_Data_Address, int Total_Size_Of_Receiver_Noise_Data, int BlockSize, double Receiver_Gain, double Band_Width, double Noise_Factor, double Impedance, double Impedance_Temperature, double Logarithmic_Amplifier_Voltage, int Count_Of_Sampling_Point_Of_Monopulse, int Count_Of_Pulse_Group, int Antenna_Chanel_Count)
{
