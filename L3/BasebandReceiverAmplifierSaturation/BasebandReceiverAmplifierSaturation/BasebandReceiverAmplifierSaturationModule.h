#ifndef BASEBANDRECEIVERAMPLIFIERSATURATIONMODULE_H 
#define BASEBANDRECEIVERAMPLIFIERSATURATIONMODULE_H
...
#include "../HeaderFileOfHierarchy2DLL/CUDABasebandReceiverAmplifierSaturation.h"
namespace GPUSignalAlgorithm
{
	class BASEBAND_RECEIVER_AMPLIFIER_SATURATION_EXPORTS BasebandReceiverAmplifierSaturationModule
	{
	public:
		BasebandReceiverAmplifierSaturationModule();
		~BasebandReceiverAmplifierSaturationModule();
	...
	private:
		CUDABasebandReceiverAmplifierSaturationNamespace::CUDABasebandReceiverAmplifierSaturation * CUDA_Baseband_Receiver_Amplifier_Saturation_Pointer;
